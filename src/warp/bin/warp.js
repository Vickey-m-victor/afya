...
if (!fs.existsSync('afya365.cfg')) {
  console.error(chalk.red('❌ Error: Missing afya365 config file!'));
  console.error(chalk.red('Please create an afya365.cfg file with the required configuration.'));
  process.exit(1);
}
...
if (!process.env.API_BASE_URL) {
  ...
  console.error(chalk.red('Please add API_BASE_URL=<your_api_url> to your afya365.cfg file.'));
  process.exit(1);
}
