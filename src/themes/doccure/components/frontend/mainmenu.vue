<template>
  <ul class="main-nav" v-bind:class="$route.meta.headerMainNavClass">
    <li class="has-submenu megamenu" :class="homeMenu ? 'active' : 'notactive'">
		<a href="javascript:void(0);" @click="toggleVisibilityhome">Home <i class="fas fa-chevron-down"></i></a>
		<ul class="submenu mega-submenu" :style="{ display: isVisiblehome ? 'block' : 'none' }">
			<li>
					...
					<div class="row">
						...
						<div class="col-lg-2">
							<div class="single-demo" :class="currentPath == '/index-2' ? 'active' : 'notactive'">
								<div class="demo-img">
									<router-link href="/index-2" class="inner-demo-img">
    ...
    <li class="has-submenu" :class="patientsMenu ? 'active' : 'notactive'">
      ...
      <ul class="submenu" :style="{ display: isVisiblepatients ? 'block' : 'none' }">
        ...
        >
          ...
          >
            ...
            <li :class="currentPath == 'map-list-availability' ? 'active' : 'notactive'">
              <router-link @click="redirectReloadmaplist" to="/map-list-availability"
                >Map with Availability</router-link
              >
            </li>
          </ul>
        </li>
        <li
          class="has-submenu"
          :class="
            currentPath == 'search' || currentPath == 'search-2' ? 'active' : 'notactive'
          "
        >
          ...
          >
            ...
            <li :class="currentPath == 'search-2' ? 'active' : 'notactive'">
              <router-link @click="redirectReloadsearch" to="/search-2"
    ...
    <li v-if="isHomeTen">
      <div class="dropdown header-dropdown country-flag">
        ...
        >
          <img src="@/themes/doccure/assets/img/flags/us.png" alt="Img" />English
        </a>
        <div class="dropdown-menu dropdown-menu-end">
          <a href="javascript:void(0);" class="dropdown-item">
            <img src="@/themes/doccure/assets/img/flags/fr.png" alt="Img" />French
          </a>
          <a href="javascript:void(0);" class="dropdown-item">
            <img src="@/themes/doccure/assets/img/flags/es.png" alt="Img" />Spanish
          </a>
          <a href="javascript:void(0);" class="dropdown-item">
            <img src="@/themes/doccure/assets/img/flags/de.png" alt="Img" />German
          </a>
        </div>
      </div>
    </li>
