                ...
                <div class="row">
                    <div class="col-lg-12 p-0">
                        <div class="right-panel-title text-center">
                            <router-link to="/"> <img src="@/themes/doccure/assets/img/onboard-img/onb-logo.png" alt="Image"></router-link>
                        </div>
                    </div>
                                                            ...
                                                            <div class="consult-option mb-lg-4 mb-sm-1">
                                                                <div class="call-option">
                                                                    ...
                                                                    <label for="radio1" class="call-lable"> <img
                                                                            src="@/themes/doccure/assets/img/icons/mic-black.svg"
                                                                ...
                                                                <div class="call-option">
                                                                    ...
                                                                    <label for="radio2" class="call-lable"><img
                                                                            src="@/themes/doccure/assets/img/icons/video-icon.svg"
                                                                ...
                                                                <div class="call-option">
                                                                    ...
                                                                    <label for="radio3" class="call-lable"> <img
                                                                            src="@/themes/doccure/assets/img/icons/ch.svg"
                                                                ...
                                                                <div class="modal-dialog id-upload modal-dialog-centered">
                                                                    <div class="modal-content id-pop-content">
                                                                        <div
                                                                            ...
                                                                            <img src="@/themes/doccure/assets/img/icons/success-tick.svg"
                                                                                alt="Image">
                                                                        </div>
