                ...
                <div class="row">
                    <div class="col-lg-12 p-0">
                        <div class="right-panel-title text-center">
                            <img src="@/themes/doccure/assets/img/onboard-img/onb-logo.png" alt="doccure-logo">
                        </div>
                    </div>
                            ...
                            <div class="onboarding-content">
                                <div class="consult-option mb-lg-4 mb-sm-1">
                                    <div class="call-option">
                                        ...
                                        <label for="radio1" class="call-lable"> <img src="@/themes/doccure/assets/img/icons/mic-black.svg"
                                                alt="mic-icon">Audio Call</label>
                                    </div>
                                    <div class="call-option">
                                        <input type="checkbox" id="radio2" name="selector" class="option-radio">
                                        <label for="radio2" class="call-lable"><img src="@/themes/doccure/assets/img/icons/video-icon.svg"
                                                alt="video-icon">Video Call</label>
                                    </div>
                                    <div class="call-option">
                                        <input type="checkbox" id="radio3" name="selector" class="option-radio">
                                        <label for="radio3" class="call-lable"> <img src="@/themes/doccure/assets/img/icons/ch.svg"
