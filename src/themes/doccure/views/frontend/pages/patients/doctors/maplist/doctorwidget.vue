        ...
        <div class="doc-info-left">
          <div class="doctor-img">
            <router-link to="doctor-profile">
              <img
                :src="require(`@/themes/doccure/assets/img/doctors/${item.DoctorImg}`)"
                class="img-fluid"
                alt="User Image"
              />
            </router-link>
          ...
          <div class="doc-info-cont">
            ...
            <h5 class="doc-department">
              <img
                :src="require(`@/themes/doccure/assets/img/specialities/${item.SpecialityImg}`)"
                class="img-fluid"
                alt="Speciality"
              />{{ item.Speciality }}
            </h5>
...
import map_list from "@/themes/doccure/assets/json/patient-doctors/map-list.json";
export default {
  components: {
    VueEasyLightbox,
  },
