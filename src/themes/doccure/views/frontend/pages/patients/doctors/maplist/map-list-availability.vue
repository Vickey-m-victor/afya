                          ...
                          <div class="doctor-available-profile">
                            <div class="d-flex align-items-center mb-4">
                              <div class="position-relative">
                                <span class="avail-img"
                                  ><img
                                    src="@/themes/doccure/assets/img/doctor-grid/doctor-grid-05.jpg"
                                    alt=""
                                /></span>
                                <span class="avail-check"
                                  ><i class="isax isax-tick-circle5 text-success"></i
                                ></span>
                              </div>
                              <div>
                            ...
                            <div>
                              ...
                              <p class="mb-2">
                                Consultation Fees :
                                <span class="text-orange fw-semibold fs-18">$650</span>
                              </p>
                              <a
                                href="#"
...
export default {
  data() {
    return {
      ...
      StatPaimapava: ["Reviews", "5 Star", "4 Star", "3 Star"],
      DentalSelmapava: [
        "Clinic",
