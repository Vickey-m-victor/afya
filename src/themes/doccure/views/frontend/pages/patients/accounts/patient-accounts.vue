<template>
                ...
                <div class="row">
                      ...
                      <div class="row">
                        <div class="col-lg-6 col-md-6">
                          <div class="payment-amount">
                            <h6>
                              <i class="isa isax-wallet-25 text-warning"></i>Total Balance
                            </h6>
                            <span>$1200</span>
                          </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                          <div class="payment-amount">
                            <h6>
                              <i class="isax isax-document5 text-success"></i>Total
                              Transaction
                            </h6>
                            <span>$2300</span>
                          </div>
                  ...
                  <div class="col-xxl-5 col-lg-5">
                    <div class="bank-details-info">
                      ...
                      <div
                        class="edit-detail-link d-flex align-items-center justify-content-between w-100"
                      >
                        <div>
                      ...
                      <table class="table table-center mb-0">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <span
                                class="badge badge-success-transparent inline-flex align-items-center"
                          ...
                          <tr>
                            ...
                            <td>
                              <span
                                class="badge badge-warning-transparent inline-flex align-items-center"
                                ><i class="fa-solid fa-circle me-1 fs-5"></i>Pending</span
                              >
                            </td>
                          </tr>
                          <tr>
  ...
  <patient-accounts-modal></patient-accounts-modal>
</template>
<script>
export default {
  data() {
