          ...
          <div class="col-lg-8 col-xl-9">
            <div class="dashboard-header">
              <div class="header-back">
                <router-link to="/patient-appointments" class="back-arrow"
                ...
                <ul>
                  ...
                  <li class="appointment-info">
                    ...
                    <div class="person-info">
                      ...
                      <ul class="d-flex apponitment-types">
                        <li><i class="isax isax-video5 text-indigo"></i>Video Call</li>
                      </ul>
                    </div>
                  </li>
                  <li class="appointment-action">
                    <div class="detail-badge-info">
                      ...
                      <a href="#reject_reason" class="reject-popup" data-bs-toggle="modal"
                        >Reason</a
                      >
                    </div>
                ...
                <ul class="detail-card-bottom-info">
                  ...
                  <li>
                    <div class="detail-badge-info">
                      ...
                      <router-link
                        to="/booking-popup"
                        class="reschedule-btn btn btn-primary-gradient rounded-pill"
