                ...
                <ul>
                  <li>
                    <div class="patinet-information">
                      <a href="#">
                        <img
                          src="@/themes/doccure/assets/img/doctors-dashboard/doctor-profile-img.jpg"
                          alt="User Image"
                        />
                      </a>
                  ...
                  <li class="appointment-info">
                    <div class="person-info">
                      ...
                      <ul class="d-flex apponitment-types">
                        <li>
                          <i class="fa-solid fa-hospital text-green"></i>Direct
                          Visit
                        </li>
                      </ul>
                    </div>
                  ...
                  <li>
                    <div class="detail-badge-info">
                      ...
                      <router-link to="/booking-2"
                        class="reschedule-btn btn-primary-border"
                        >Reschedule Appointment</router-link
                      >
                    </div>
                  </li>
                </ul>
                ...
                <ul class="detail-card-bottom-info">
                  ...
                  <li class="detail-badge-info">
                    <a
                      ...
                      data-bs-toggle="modal"
                      class="btn btn-primary prime-btn me-3"
                      >Download Prescription</a
                    >
                    <a href="#" class="btn reschedule-btn btn-primary-border"
                  ...
                  <ul>
                    <li>
                      <div class="patinet-information">
                        <a href="#">
                          <img
                            src="@/themes/doccure/assets/img/doctors/doctor-15.jpg"
                            alt="User Image"
                          />
                        </a>
                        <div class="patient-info">
                    ...
                    <li class="mail-info-patient">
                      <ul>
                        <li>
                          <i class="fa-solid fa-envelope"></i>shanta@example.com
                        </li>
                        <li>
                          <i class="fa-solid fa-phone"></i> +1 504 368 6874
                        </li>
                ...
                <div class="appointment-wrap">
                  <ul>
                    ...
                    <li class="mail-info-patient">
                      <ul>
                        <li>
                          <i class="fa-solid fa-envelope"></i>john@example.com
                        </li>
                        <li>
