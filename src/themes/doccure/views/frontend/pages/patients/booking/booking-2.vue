            ...
            <div class="booking-date choose-date-book">
              ...
              <div class="booking-range">
                <div class="bookingrange btn" ref="bookingRange">
                  <img
                    src="@/themes/doccure/assets/img/icons/today-icon.svg"
                    alt="calendar-mage"
                  />
                  <span></span>
                  ...
                  <div class="booking-doctor-left">
                    <div class="booking-doctor-img">
                      <router-link to="/doctor-profile">
                        <img
                          src="@/themes/doccure/assets/img/doctors/doctor-01.jpg"
                          alt="John Doe"
                        />
                      </router-link>
                    </div>
              ...
              <div class="card-body booking-card-body">
                <div class="booking-doctor-details">
                  <div class="booking-device">
                    <div class="booking-device-img">
                      <img
                        src="@/themes/doccure/assets/img/icons/smart-phone.svg"
                        alt="smart-phone"
                      />
                    </div>
                    <div class="booking-doctor-info">
                      ...
                      <div class="app-images">
                        <a href="javascript:void(0);">
                          <img
                            src="@/themes/doccure/assets/img/google-img.svg"
                            alt="google-image"
                          />
                        </a>
                        <a href="javascript:void(0);">
...
import Booking from "@/themes/doccure/assets/json/booking/booking-2.json";
