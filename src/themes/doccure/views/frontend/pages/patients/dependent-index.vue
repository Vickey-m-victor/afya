<template>
          ...
          <div class="col-lg-8 col-xl-9">
              ...
              <div class="dependent-info">
                <div class="patinet-information">
                  <router-link to="/patient-profile">
                    <img src="@/themes/doccure/assets/img/dependent/dependent-01.jpg" alt="User Image" />
                  </router-link>
            ...
            <div class="dependent-wrap">
              <div class="dependent-info">
                <div class="patinet-information">
                  <router-link to="/patient-profile">
                    <img src="@/themes/doccure/assets/img/dependent/dependent-02.jpg" alt="User Image" />
                  </router-link>
                  <div class="patient-info">
                    <h5>Mathew</h5>
                    <ul>
            ...
            <div class="dependent-wrap">
              <div class="dependent-info">
                <div class="patinet-information">
                  <router-link to="/patient-profile">
                    <img src="@/themes/doccure/assets/img/dependent/dependent-03.jpg" alt="User Image" />
                  </router-link>
                  <div class="patient-info">
                    <h5>Christopher</h5>
                    <ul>
            ...
            <div class="dependent-wrap">
              <div class="dependent-info">
                <div class="patinet-information">
                  <router-link to="/patient-profile">
                    <img src="@/themes/doccure/assets/img/dependent/dependent-04.jpg" alt="User Image" />
                  </router-link>
                  <div class="patient-info">
                    <h5>Elisa</h5>
                    <ul>
  ...
  <dependent-modal></dependent-modal>
</template>
<script>
export default {
  data() {
