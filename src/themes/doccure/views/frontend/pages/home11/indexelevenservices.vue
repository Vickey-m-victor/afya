<template>
  ...
  <div class="features-section-sixteen">
    <div class="bg-img">
      <img src="@/themes/doccure/assets/img/bg/vector-bg-05.png" class="sec-vector" alt="Img">
    </div>
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          ...
          <Slide v-for="item in IndexElevenServices" :key="item.id">
            <div class="feature-sixteen-main">
              <div class="feature-six-img">
                <img :src="require(`@/themes/doccure/assets/img/${item.Image}`)" alt="Feature" class="img-fluid">
...
import IndexElevenServices from "@/themes/doccure/assets/json/indexelevenservices.json";
