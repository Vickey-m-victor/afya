    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-6 col-md-12 review-big-img">
          <img
            src="@/themes/doccure/assets/img/reviews/review-img.png"
            class="img-fluid"
            alt="Review Img"
          />
        </div>
          ...
          <div class="review-info">
            <div class="review-grid">
              <div class="review-img">
                <img src="@/themes/doccure/assets/img/reviews/review-01.jpg" alt="Review Img" />
              </div>
            ...
            <div class="review-grid">
              <div class="review-img">
                <img src="@/themes/doccure/assets/img/reviews/review-02.jpg" alt="Review Img" />
              </div>
              <div class="review-content">
                <div class="rating">
                  <i class="fas fa-star filled"></i>
            ...
            <div class="review-grid">
              <div class="review-img">
                <img src="@/themes/doccure/assets/img/reviews/review-03.jpg" alt="Review Img" />
              </div>
              <div class="review-content">
                <div class="rating">
                  <i class="fas fa-star filled"></i>
            ...
            <div class="review-grid">
              <div class="review-img">
                <img src="@/themes/doccure/assets/img/reviews/review-04.jpg" alt="Review Img" />
              </div>
              <div class="review-content">
                <div class="rating">
                  <i class="fas fa-star filled"></i>
