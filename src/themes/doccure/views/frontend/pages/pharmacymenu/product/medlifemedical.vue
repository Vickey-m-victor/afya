    ...
    <div class="row align-items-center pb-3">
      <div class="col-md-4 col-12 d-md-block d-none custom-short-by">
        ...
        <p class="doc-location mb-2 text-ellipse pharmacy-location">
          <i class="isax isax-location5 me-1"></i> 96 Red Hawk Road Cyrus, MN 56323
        </p>
          ...
          <div class="doc-img">
            <router-link to="/product-description" tabindex="-1">
              <img
                class="img-fluid"
                alt="Product image"
                :src="require(`@/themes/doccure/assets/img/products/${item.image}`)"
              />
            </router-link>
...
<script>
import productall from "@/themes/doccure/assets/json/pharmacy/productall.json";
export default {
  data() {
    return {
