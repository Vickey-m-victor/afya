<template>
    ...
    <section class="best-packages-section">
        <div class="section-bg">
            <img src="@/themes/doccure/assets/img/bg/section-bg-03.png" class="best-pack-bg-one" alt="Img">
            <img src="@/themes/doccure/assets/img/bg/section-bg-04.png" class="best-pack-bg-two" alt="Img">
        </div>
        <div class="container">
            ...
            <div class="how-it-work">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="600">
                        <div class="work-box">
                            <div class="work-icon">
                                <img src="@/themes/doccure/assets/img/icons/work-icon-07.svg" alt="Img">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="700">
                        <div class="work-box bg-green">
                            <div class="work-icon">
                                <img src="@/themes/doccure/assets/img/icons/work-icon-06.svg" alt="Img">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="800">
                        <div class="work-box">
                            <div class="work-icon">
                                <img src="@/themes/doccure/assets/img/icons/work-icon-05.svg" alt="Img">
                            </div>
