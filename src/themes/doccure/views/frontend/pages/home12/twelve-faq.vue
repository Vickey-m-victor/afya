<template>
        ...
        <div class="container">
            ...
            <div class="choice-slider-main">
                                ...
                                <Slide v-for="item in TwelveChoices" :key="item.id">
                                    <div class="popular-choice-card">
                                        <div class="choice-head text-start">
                                            ...
                                            <h6><span><img src="@/themes/doccure/assets/img/icons/gem.svg" alt="Img"></span>{{item.Text}}</h6>
                                        </div>
                ...
                <div class="book-lab-phno">
                    <span>Want to Book a Lab Visit, <a href="javascript:void(0);"> Call – +1 234 567 90</a></span>
                </div>
            </div>
    ...
    <section class="faq-sec-twelve">
        <div class="section-bg">
            <img src="@/themes/doccure/assets/img/icons/faq-sec-bg-icon.svg" class="faq-bg-one" alt="Img">
        </div>
        <div class="container">
            <div class="row">
...
<script>
import TwelveChoices from '@/themes/doccure/assets/json/twelve-choices.json'
