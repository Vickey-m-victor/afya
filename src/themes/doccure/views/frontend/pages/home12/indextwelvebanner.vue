<template>
  ...
  <section class="banner-sec-twelve">
    <div class="section-small-imgs">
      <img
        src="@/themes/doccure/assets/img/icons/section-small-icon-01.svg"
        class="small-icon-one"
        alt="Img"
      />
      <img
        src="@/themes/doccure/assets/img/icons/section-small-icon-02.svg"
        ...
        <div class="col-lg-8">
          <div class="banner-content-twelve">
            ...
            <div class="view-all-lab" data-aos="fade-up">
              <span
                ><img src="@/themes/doccure/assets/img/icons/lab-view-icon.svg" alt="Img"
              /></span>
                  ...
                  <div class="swiper-slide">
                    <div class="img-swiper">
                      <router-link to="/consultation"
                        ><img
                          :src="require(`@/themes/doccure/assets/img/slider/${item.Image}`)"
                          class="img-fluid"
                          alt="Img"
                      /></router-link>
                    </div>
  ...
  <section class="popular-test-section">
    <div class="section-small-imgs">
      <img
        src="@/themes/doccure/assets/img/bg/section-bg-01.jpg"
        class="bg-img-one"
        alt="Img"
      />
      <img
        src="@/themes/doccure/assets/img/bg/section-bg-02.png"
        class="bg-img-two"
        alt="Img"
      />
    </div>
        ...
        <div class="row">
          <div class="col-xl-3 col-md-4 col-sm-6">
            <div class="description-item">
              <span
                ><img src="@/themes/doccure/assets/img/icons/medical-icon-01.svg" alt="Img"
              /></span>
          ...
          <div class="col-xl-3 col-md-4 col-sm-6">
            <div class="description-item">
              <span
                ><img src="@/themes/doccure/assets/img/icons/medical-icon-02.svg" alt="Img"
              /></span>
          ...
          <div class="col-xl-3 col-md-4 col-sm-6">
            <div class="description-item">
              <span
                ><img src="@/themes/doccure/assets/img/icons/medical-icon-03.svg" alt="Img"
              /></span>
          ...
          <div class="col-xl-3 col-md-4 col-sm-6">
            <div class="description-item">
              <span
                ><img src="@/themes/doccure/assets/img/icons/medical-icon-04.svg" alt="Img"
              /></span>
...
<script>
import TwelveBanner from "@/themes/doccure/assets/json/twelve-banner.json";
