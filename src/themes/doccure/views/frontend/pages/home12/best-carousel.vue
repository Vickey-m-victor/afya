                        ...
                        <div class="best-package-card">
                            <div class="package-card-top">
                                <div class="card-img-right">
                                    <img :src="require(`@/themes/doccure/assets/img/icons/${item.Sticker}`)" :class="item.Class" alt="Img">
                                </div>
                                <div class="package-icon">
                                    <img :src="require(`@/themes/doccure/assets/img/icons/${item.Package}`)" alt="Img">
                                </div>
...
import BestCarousel from "@/themes/doccure/assets/json/best-carousel.json";
