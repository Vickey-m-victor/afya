<template>
    ...
    <section class="booking-lab-test-sec">
        <div class="section-bg">
            <img src="@/themes/doccure/assets/img/icons/book-lab-bg-01.svg" class="best-pack-bg-one" alt="Img">
            <img src="@/themes/doccure/assets/img/icons/book-lab-bg-02.svg" class="best-pack-bg-two" alt="Img">
        </div>
        <div class="container">
                            ...
                            <Slide v-for="item in TwelveBook" :key="item.id">
                                <div class="booking-lab-grid">
                                    <div class="booking-lab-img">
                                        <router-link to="/consultation"><img :src="require(`@/themes/doccure/assets/img/blog/${item.Image}`)"
...
<script>
import TwelveBook from '@/themes/doccure/assets/json/twelve-book.json'
