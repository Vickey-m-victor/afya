          ...
          <div class="row align-items-center">
            <div class="col-lg-6 col-md-12">
              <div class="mobile-img">
                <img
                  src="@/themes/doccure/assets/img/mobile-img.png"
                  class="img-fluid"
                  alt="img"
                />
              </div>
            ...
            <div class="col-lg-6 col-md-12">
              <div class="app-content">
                ...
                <div class="app-scan">
                  ...
                  <img src="@/themes/doccure/assets/img/scan-img.png" alt="scan-image" />
                </div>
                <div class="google-imgs aos" data-aos="fade-up">
                  <a href="javascript:void(0);"
                    ><img src="@/themes/doccure/assets/img/google-play.png" alt="img"
                  /></a>
                  <a href="javascript:void(0);"
                    ><img src="@/themes/doccure/assets/img/app-store.png" alt="img"
                  /></a>
                </div>
              </div>
            </div>
      ...
      <div class="container">
        <div class="footer-top">
          <div class="logo-footer">
            <img src="@/themes/doccure/assets/img/icons/footer-logo-.svg" alt="Img">
          </div>
            ...
            <div class="col-lg-4 col-sm-6">
              <div class="footer-links-middle">
                ...
                <ul class="social-icons">
                  ...
                  <li><a href="javascript:void(0);" class="social-media"><i class="fa-brands fa-x-twitter"></i></a></li>
                  ...
                  <li><a href="javascript:void(0);" class="social-media"><i class="fa-brands fa-pinterest"></i></a></li>
                </ul>
              </div>
            </div>
          </div>
