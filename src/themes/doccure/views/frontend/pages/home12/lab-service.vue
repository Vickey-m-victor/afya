<template>
    ...
    <section class="lab-service-section">
        <div class="sec-bg">
            <img src="@/themes/doccure/assets/img/icons/section-small-icon-02.svg" class="small-icon-two" alt="Img">
        </div>
                    ...
                    <div class="servive-provider-content">
                        ...
                        <div class="lab-service-features">
                            <ul>
                                <li>
                                    <span>
                                        <img src="@/themes/doccure/assets/img/icons/lab-service-icon-01.svg" alt="Img">
                                    </span>
                                    <h6>The Doccure - Easy Way To Book Lab Tests Online</h6>
                                </li>
                                <li>
                                    <span>
                                        <img src="@/themes/doccure/assets/img/icons/lab-service-icon-02.svg" alt="Img">
                                    </span>
                                    <h6>Lab Test Booking Made Simple</h6>
                                </li>
                                <li>
                                    <span>
                                        <img src="@/themes/doccure/assets/img/icons/lab-service-icon-03.svg" alt="Img">
                                    </span>
