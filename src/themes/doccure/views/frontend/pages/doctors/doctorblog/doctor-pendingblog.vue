                  ...
                  <div class="blog grid-blog">
                    <div class="blog-image">
                      <router-link to="/blog-details"
                        ><img
                          class="img-fluid"
                          :src="
                            require(`@/themes/doccure/assets/img/blog/${item.blogImageSrc}`)
                          "
                          alt="Post Image"
                      /></router-link>
                    </div>
                    <div class="blog-content">
                      <ul class="entry-meta meta-item">
                        <li>
                          <div class="post-author">
                            <router-link to="/doctor-profile"
                              ><img
                                :src="
                                  require(`@/themes/doccure/assets/img/doctors/${item.authorImageSrc}`)
                                "
                                alt="Post Author"
                              />
                        ...
                        <li>
                          <i class="far fa-clock"></i> {{ item.blogDate }}
                        </li>
                      </ul>
                      <h3 class="blog-title">
                        <router-link to="/blog-details">
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <a href="javascript:void(0)" class="btn btn-success si_accept_confirm"
            >Yes</a
          >
          <b-button
            type="button"
...
<script>
import doctorpendingblog from "@/themes/doccure/assets/json/doctor/doctorpendingblog.json";
