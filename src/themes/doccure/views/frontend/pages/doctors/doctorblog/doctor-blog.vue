              ...
              <div class="row mb-5">
                <div class="col">
                  <ul class="nav nav-tabs nav-tabs-solid">
                    <li class="nav-item">
                      <router-link class="nav-link active" to="/doctor-blog"
                  ...
                  <div class="blog grid-blog">
                    <div class="blog-image">
                      <router-link to="/blog-details"
                        ><img
                          class="img-fluid"
                          :src="require(`@/themes/doccure/assets/img/blog/${item.imageUrl}`)"
                          alt="Post Image"
                      /></router-link>
                    </div>
                    <div class="blog-content">
                      <ul class="entry-meta meta-item">
                        <li>
                          <div class="post-author">
                            <router-link to="/doctor-profile"
                              ><img
                                :src="
                                  require(`@/themes/doccure/assets/img/doctors/${item.authorImage}`)
                                "
                                alt="Post Author"
                              />
                        ...
                        <li>
                          <i class="far fa-clock"></i> {{ item.postDate }}
                        </li>
                      </ul>
                      <h3 class="blog-title">
                        <router-link to="/blog-details">
...
<script>
import doctorblog from "@/themes/doccure/assets/json/doctor/doctorblog.json";
