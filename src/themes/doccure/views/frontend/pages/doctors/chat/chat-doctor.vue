<template>
    ...
    <div class="main-chat-blk">
                ...
                <div class="container">
                    ...
                    <div class="content">
                        ...
                        <div class="dashboard-header">
                            <h3><router-link to="/doctor-dashboard"><i class="fa-solid fa-arrow-left"></i>
                                    Message</router-link></h3>
                        </div>
                        ...
                        <div class="chat-sec">
                                        ...
                                        <div class="top-online-contacts">
                                            ...
                                            <div class="swiper-container">
                                                <div class="swiper-wrapper">
                                                    <div class="swiper-slide" v-for="item in ChatSlider" :key="item.id">
                                                        <div class="top-contacts-box">
                                                            <div class="profile-img online">
                                                                <img :src="require(`@/themes/doccure/assets/img/doctors-dashboard/${item.Image}`)"
                                                                    alt="Img">
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="sidebar-body chat-body" id="chatsidebar">
                                            ...
                                            <ul class="user-list">
                                                <li class="user-list-item">
                                                    <a href="javascript:void(0);" @click="toggleChatbar">
                                                        <div class="avatar avatar-online">
                                                            <img src="@/themes/doccure/assets/img/doctors-dashboard/profile-01.jpg"
                                                                alt="image">
                                                        </div>
                                                ...
                                                <li class="user-list-item">
                                                    <a href="javascript:void(0);" @click="toggleChatbar">
                                                        <div class="avatar ">
                                                            <img src="@/themes/doccure/assets/img/doctors-dashboard/doctor-profile-img.jpg"
                                                                alt="image">
                                                        </div>
                                                        <div class="users-list-body">
                                                            <div>
                                                ...
                                                <li class="user-list-item">
                                                    <a href="javascript:void(0);" @click="toggleChatbar">
                                                        <div class="avatar avatar-online">
                                                            <img src="@/themes/doccure/assets/img/doctors-dashboard/profile-04.jpg"
                                                                alt="image">
                                                        </div>
                                                        <div class="users-list-body">
                                                            <div>
                                            ...
                                            <ul class="user-list">
                                                <li class="user-list-item">
                                                    <a href="javascript:void(0);" @click="toggleChatbar">
                                                        <div class="avatar avatar-online">
                                                            <img src="@/themes/doccure/assets/img/doctors-dashboard/profile-02.jpg"
                                                                alt="image">
                                                        </div>
                                                        <div class="users-list-body">
                                                            <div>
                                                ...
                                                <li class="user-list-item">
                                                    <a href="javascript:void(0);" @click="toggleChatbar">
                                                        <div>
                                                            <div class="avatar avatar-online">
                                                                <img src="@/themes/doccure/assets/img/doctors-dashboard/profile-05.jpg"
                                                                    alt="image">
                                                            </div>
                                                        </div>
                                                        <div class="users-list-body">
                                                ...
                                                <li class="user-list-item">
                                                    <a href="javascript:void(0);" @click="toggleChatbar">
                                                        <div class="avatar">
                                                            <img src="@/themes/doccure/assets/img/doctors-dashboard/profile-08.jpg"
                                                                alt="image">
                                                        </div>
                                                        <div class="users-list-body">
                                                            <div>
                                                ...
                                                <li class="user-list-item">
                                                    <a href="javascript:void(0);" @click="toggleChatbar">
                                                        <div>
                                                            <div class="avatar avatar-online">
                                                                <img src="@/themes/doccure/assets/img/doctors-dashboard/profile-03.jpg"
                                                                    alt="image">
                                                            </div>
                                                        </div>
                                                        <div class="users-list-body">
                                                ...
                                                <li class="user-list-item">
                                                    <a href="javascript:void(0);" @click="toggleChatbar">
                                                        <div>
                                                            <div class="avatar avatar-online">
                                                                <img src="@/themes/doccure/assets/img/doctors-dashboard/profile-07.jpg"
                                                                    alt="image">
                                                            </div>
                                                        </div>
                                                        <div class="users-list-body">
                                                ...
                                                <li class="user-list-item">
                                                    <a href="javascript:void(0);" @click="toggleChatbar">
                                                        <div>
                                                            <div class="avatar">
                                                                <img src="@/themes/doccure/assets/img/doctors-dashboard/profile-06.jpg"
                                                                    alt="image">
                                                            </div>
                                                        </div>
                                                        <div class="users-list-body">
                            ...
                            <!-- Chat -->
                            <div class="chat chat-messages" id="middle" :class="{ 'show-chatbar': showChatbar }">
                                    ...
                                    <div class="chat-inner-header">
                                        <div class="chat-header">
                                            <div class="user-details">
                                                <div class="d-lg-none">
                                                    <ul class="list-inline mt-2 me-2">
                                                        <li class="list-inline-item">
                                                            <a class="text-muted px-0 left_sides" @click="hideSidebar" href="#"
                                                                data-chat="open">
                                                ...
                                                <figure class="avatar ms-1 avatar-online">
                                                    <img src="@/themes/doccure/assets/img/doctors-dashboard/profile-06.jpg"
                                                        alt="image">
                                                </figure>
                                                <div class="mt-1">
                                                                    ...
                                                                    <div class="emoj-group-list">
                                                                        <ul>
                                                                            <li><a href="javascript:void(0);"><img
                                                                                        src="@/themes/doccure/assets/img/icons/emoj-icon-01.svg"
                                                                                        alt="Icon"></a></li>
                                                                            <li><a href="javascript:void(0);"><img
                                                                                        src="@/themes/doccure/assets/img/icons/emoj-icon-02.svg"
                                                                                        alt="Icon"></a></li>
                                                                            <li><a href="javascript:void(0);"><img
                                                                                        src="@/themes/doccure/assets/img/icons/emoj-icon-03.svg"
                                                                                        alt="Icon"></a></li>
                                                                            <li><a href="javascript:void(0);"><img
                                                                                        src="@/themes/doccure/assets/img/icons/emoj-icon-04.svg"
                                                                                        alt="Icon"></a></li>
                                                                            <li><a href="javascript:void(0);"><img
                                                                                        src="@/themes/doccure/assets/img/icons/emoj-icon-05.svg"
                                                                                        alt="Icon"></a></li>
                                                                            <li class="add-emoj"><a
                                                        ...
                                                        <div class="chat-voice-group">
                                                            <ul>
                                                                <li><a href="javascript:void(0);"><span><img
                                                                                src="@/themes/doccure/assets/img/icons/play-01.svg"
                                                                                alt="image"></span></a></li>
                                                                <li><img src="@/themes/doccure/assets/img/icons/voice.svg" alt="image">
                                                                </li>
                                                                <li>0:05</li>
                                                            </ul>
                                                        </div>
                                            ...
                                            <div class="chats">
                                                ...
                                                <div class="chat-content">
                                                    ...
                                                    <div class="message-content award-link chat-award-link">
                                                        ...
                                                        <img src="@/themes/doccure/assets/img/sending-img.jpg" alt="img">
                                                        <div class="emoj-group">
                                                            <ul>
                                                                <li class="emoj-action"><a href="javascript:void(0);"><i
                                                                            class="fa-regular fa-face-smile"></i></a>
                                                    ...
                                                    <div class="like-chat-grp">
                                                        <ul>
                                                            <li class="like-chat"><a href="javascript:void(0);">2<img
                                                                        src="@/themes/doccure/assets/img/icons/like.svg"
                                                                        alt="Icon"></a>
                                                            </li>
                                                            <li class="comment-chat"><a href="javascript:void(0);">2<img
                                                                        src="@/themes/doccure/assets/img/icons/heart.svg"
                                                                        alt="Icon"></a>
                                                            </li>
                                                        </ul>
                                                    </div>
        ...
        <chat-doctor-modal></chat-doctor-modal>
...
<script>
import ChatSlider from '@/themes/doccure/assets/json/chat-slider-image.json'
export default {
    data() {
        return {
            title: "Message",
