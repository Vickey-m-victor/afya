<template>
              ...
              <div class="stripe-wrapper">
                <div class="stripe-box">
                  <div class="stripe-img">
                    <img src="@/themes/doccure/assets/img/icons/stripe.svg" alt="img" />
                  </div>
                  <a href="javascript:void(0);" class="btn"
                    ><i class="fa-solid fa-gear"></i>Configure</a
                  >
                </div>
                <div class="stripe-box active">
                  <div class="stripe-img">
                    <img src="@/themes/doccure/assets/img/icons/paypal.svg" alt="img" />
                  </div>
                  <a
  ...
  <doctor-payment-modal></doctor-payment-modal>
</template>
<script>
export default {
  data() {
