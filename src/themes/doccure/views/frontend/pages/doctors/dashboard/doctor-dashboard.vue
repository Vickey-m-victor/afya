                          ...
                          <tr>
                            <td>
                              <div class="patient-info-profile">
                                <router-link to="/appointments" class="table-avatar">
                                  <img
                                    src="@/themes/doccure/assets/img/doctors-dashboard/profile-01.jpg"
                                    alt="Img"
                                  />
                                </router-link>
                          ...
                          <tr>
                            <td>
                              <div class="patient-info-profile">
                                <router-link to="/appointments" class="table-avatar">
                                  <img
                                    src="@/themes/doccure/assets/img/doctors-dashboard/profile-02.jpg"
                                    alt="Img"
                                  />
                                </router-link>
                                <div class="patient-name-info">
                          ...
                          <tr>
                            <td>
                              <div class="patient-info-profile">
                                <router-link to="/appointments" class="table-avatar">
                                  <img
                                    src="@/themes/doccure/assets/img/doctors-dashboard/profile-03.jpg"
                                    alt="Img"
                                  />
                                </router-link>
                                <div class="patient-name-info">
                          ...
                          <tr>
                            <td>
                              <div class="patient-info-profile">
                                <router-link to="/appointments" class="table-avatar">
                                  <img
                                    src="@/themes/doccure/assets/img/doctors-dashboard/profile-04.jpg"
                                    alt="Img"
                                  />
                                </router-link>
                                <div class="patient-name-info">
                          ...
                          <tr>
                            <td>
                              <div class="patient-info-profile">
                                <router-link to="/appointments" class="table-avatar">
                                  <img
                                    src="@/themes/doccure/assets/img/doctors-dashboard/profile-05.jpg"
                                    alt="Img"
                                  />
                                </router-link>
                                <div class="patient-name-info">
                          ...
                          >
                            <div id="appointment-chart">
                              <apexchart
                                type="bar"
                                height="220"
                                :options="appointmentChart.chart"
                                :series="appointmentChart.series"
                              ></apexchart>
                            </div>
                          </div>
                        </div>
                  ...
                  <div class="dashboard-card w-100">
                    <div class="dashboard-card-head">
                      ...
                      <div class="card-view-link">
                        <router-link to="/my-patients">View All</router-link>
                      </div>
                    </div>
                    <div class="dashboard-card-body">
                      <div class="d-flex recent-patient-grid-boxes">
                        <div class="recent-patient-grid">
                          <router-link to="/patient-details" class="patient-img">
                            <img
                              src="@/themes/doccure/assets/img/doctors-dashboard/profile-01.jpg"
                              alt="Img"
                            />
                        ...
                        <div class="recent-patient-grid">
                          ...
                          <h5>
                            <router-link to="/patient-details">Kelly Stevens</router-link>
                          </h5>
                ...
                <div class="dashboard-main-col w-100">
                  <div class="upcoming-appointment-card">
                    ...
                    <div class="upcoming-patient-info">
                      ...
                      <div class="circle-bg">
                        <img src="@/themes/doccure/assets/img/bg/dashboard-circle-bg.png" alt="Img" />
                      </div>
                    </div>
                    <div class="appointment-card-footer">
                      <h5><i class="fa-solid fa-video"></i>Video Appointment</h5>
                      <div class="btn-appointments">
                        <router-link to="/chat-doctor" class="btn">Chat Now</router-link>
                        <router-link to="/doctor-appointment-start" class="btn"
                          >Start Appointment</router-link
                        >
                      </div>
                    </div>
                  </div>
                  <div class="dashboard-card w-100">
                    <div class="dashboard-card-head">
                      ...
                      <div class="card-view-link">
                        <router-link to="/invoices">View All</router-link>
                      </div>
                    </div>
                    <div class="dashboard-card-body">
                      <div class="table-responsive">
                        <table class="table dashboard-table">
                          <tbody>
                            <tr>
                              <td>
                                <div class="patient-info-profile">
                                  <router-link to="/invoices" class="table-avatar">
                                    <img
                                      src="@/themes/doccure/assets/img/doctors-dashboard/profile-01.jpg"
                                      alt="Img"
                                    />
                                  ...
                                  <div class="patient-name-info">
                                    <h5>
                                      <router-link to="/invoices">Adrian</router-link>
                                    </h5>
                                    <span>#Apt0001</span>
                                  </div>
                                </div>
                      ...
                      <div class="clinic-head">
                        <div class="clinic-info">
                          <span class="clinic-img">
                            <img
                              src="@/themes/doccure/assets/img/doctors-dashboard/clinic-02.jpg"
                              alt="Img"
                            />
                          </span>
                          <h6>Sofi’s Clinic</h6>
                    ...
                    <div class="clinic-available mb-0">
                      <div class="clinic-head">
                        <div class="clinic-info">
                          <span class="clinic-img">
                            <img
                              src="@/themes/doccure/assets/img/doctors-dashboard/clinic-01.jpg"
                              alt="Img"
                            />
                          </span>
