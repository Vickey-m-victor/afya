        ...
        <ul>
            ...
            <div class="appointment-grid-head">
              <div class="patinet-information">
                ...
                <div class="patient-info">
                  <p>#Apt0001</p>
                  <h6>
                    <router-link to="/doctor-upcoming-appointment">Adrian</router-link>
                  </h6>
                </div>
              </div>
          ...
          <li class="appointment-action">
            ...
            <div class="appointment-start">
              <router-link to="/doctor-appointment-start" class="start-link"
          ...
          <li>
            <div class="appointment-grid-head">
              <div class="patinet-information">
                <router-link to="/doctor-upcoming-appointment">
                  <img
                    src="@/themes/doccure/assets/img/doctors-dashboard/profile-06.jpg"
                    alt="User Image"
                  />
                </router-link>
                <div class="patient-info">
          ...
          <li>
            <div class="appointment-grid-head">
              <div class="patinet-information">
                <router-link to="/doctor-upcoming-appointment">
                  <img
                    src="@/themes/doccure/assets/img/doctors-dashboard/profile-07.jpg"
                    alt="User Image"
                  />
                </router-link>
                <div class="patient-info">
          ...
          <li>
            <div class="appointment-grid-head">
              <div class="patinet-information">
                <router-link to="/doctor-upcoming-appointment">
                  <img
                    src="@/themes/doccure/assets/img/doctors-dashboard/profile-08.jpg"
                    alt="User Image"
                  />
                </router-link>
                <div class="patient-info">
