                ...
                <ul class="header-list-btns">
                  ...
                  <li>
                    <div class="view-icons">
                      <router-link to="/appointments"><i class="fa-solid fa-list"></i></router-link>
                    </div>
                  </li>
                  <li>
                    <div class="view-icons">
                      <router-link to="/doctor-appointments-grid" class="active"><i
                          class="fa-solid fa-th"></i></router-link>
                    </div>
                  </li>
                  <li>
                    <div class="view-icons">
              ...
              <div class="appointment-tab-head">
                ...
                <div class="filter-head">
                  ...
                  <div class="form-sorts dropdown" :class="{ 'table-filter-show': isFilterShown }">
                    <a href="javascript:void(0);" class="dropdown-toggle" id="table-filter" @click="toggleFilter"><i
                        ...
                        <div class="accordion" id="accordionExample">
                          <div class="filter-set-content">
                            <div class="filter-set-content-head">
                              <a href="#" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false"
                                aria-controls="collapseTwo">Name<i class="fa-solid fa-chevron-right"></i></a>
                            </div>
                          ...
                          <div class="filter-set-content">
                            <div class="filter-set-content-head">
                              <a href="#" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true"
                                aria-controls="collapseOne">Appointment
                                Type<i class="fa-solid fa-chevron-right"></i></a>
                            </div>
