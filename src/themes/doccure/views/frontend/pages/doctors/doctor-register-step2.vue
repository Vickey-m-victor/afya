                    ...
                    <div class="select-gender-col">
                      <div class="row">
                        <div class="col-6 pe-2">
                          ...
                          <label for="test1">
                            <span class="gender-icon"
                              ><img src="@/themes/doccure/assets/img/icons/male.png" alt="male-icon"
                            /></span>
                            <span>Male</span>
                          </label>
                        </div>
                        <div class="col-6 ps-2">
                          ...
                          <label for="test2">
                            <span class="gender-icon"
                              ><img src="@/themes/doccure/assets/img/icons/female.png" alt="female-icon"
                            /></span>
                            <span>Female</span>
                          </label>
                        </div>
                        ...
                        <div class="row justify-content-center">
                          <div class="col-12 col-md-6 d-flex">
                            ...
                            >
                              <div class="cam-col">
                                <img
                                  src="@/themes/doccure/assets/img/icons/camera.svg"
                                  alt="camera-image"
                                />
                              </div>
