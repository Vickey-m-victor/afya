        ...
        <div class="row">
          ...
          <div class="col-lg-8 col-xl-9">
            ...
            <div class="dashboard-header border-0 mb-0">
              ...
              <ul>
                <li>
                  <a href="javascript:void(0);" class="btn btn-primary prime-btn add-educations" @click="add()">Add New
                    Education</a>
                </li>
              </ul>
            </div>
              ...
              <div class="accordions education-infos" id="list-accord">
                ...
                <div class="user-accordion-item" v-for="item in socialMedia" :key="item.id">
                  <a href="javascript:void(0);" class="accordion-wrap" data-bs-toggle="collapse"
                    data-bs-target="#education1" @click="deleteEvent(socialMedia)">Education<span>Delete</span></a>
                      ...
                      <div class="add-service-info">
                        <div class="add-info">
                          <div class="row align-items-center">
                            ...
                            <div class="col-lg-4 col-md-6">
                              <div class="form-wrap">
                                <label class="col-form-label">No of Years
                                  <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" />
                              </div>
                            </div>
...
export default {
  ...
  methods: {
    ...
    submitForm() {
      this.$router.push("/doctor-education-settings");
    },
  },
};
</script>
