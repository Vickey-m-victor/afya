                        ...
                        <div class="dash-widget dct-border-rht">
                          <div class="circle-bar circle-bar1">
                            <div class="circle-graph1">
                              ...
                              <img
                                src="@/themes/doccure/assets/img/icon-01.png"
                                class="img-fluid"
                                alt="patient"
                              />
                            </div>
                        ...
                        <div class="dash-widget dct-border-rht">
                          <div class="circle-bar circle-bar2">
                            <div class="circle-graph2">
                              ...
                              <img
                                src="@/themes/doccure/assets/img/icon-02.png"
                                class="img-fluid"
                                alt="Patient"
                              />
                            </div>
                        ...
                        <div class="dash-widget">
                          <div class="circle-bar circle-bar3">
                            <div class="circle-graph3">
                              ...
                              <img
                                src="@/themes/doccure/assets/img/icon-03.png"
                                class="img-fluid"
                                alt="Patient"
                              />
                            </div>
                                    ...
                                    <h2 class="table-avatar">
                                      <router-link
                                        ...
                                        ><img
                                          ...
                                          :src="
                                            require(`@/themes/doccure/assets/img/patients/${item.Image}`)
                                          "
                                          alt="User Image"
                                      /></router-link>
...
<script>
import doctorupcoming from "@/themes/doccure/assets/json/doctor/doctorupcoming.json";
import doctortoday from "@/themes/doccure/assets/json/doctor/doctortoday.json";
