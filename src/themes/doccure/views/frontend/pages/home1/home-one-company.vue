        ...
        <div class="container">
            ...
            <div class="owl-carousel company-slider">
                <Carousel :wrap-around="true" :autoplay="3000" :settings="settings" :breakpoints="breakpoints">
                    <Slide v-for="item in HomeOneCompany" :key="item.id">
                        <div>
                            <img :src="require(`@/themes/doccure/assets/img/company/${item.Image}`)" alt="img">
                        </div>
                    </Slide>
                </Carousel>
            </div>
...
import HomeOneCompany from "@/themes/doccure/assets/json/home-one-company.json";
import "vue3-carousel/dist/carousel.css";
export default {
  data() {
    return {
      HomeOneCompany: HomeOneCompany,
      settings: {
        itemsToShow: 1,
        snapAlign: "center",
      },
