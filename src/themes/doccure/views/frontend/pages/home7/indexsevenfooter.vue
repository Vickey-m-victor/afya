  ...
  <footer class="footer-fourteen footer-twelve">
    <div class="footer-top">
      <div class="floating-bg">
        <img src="@/themes/doccure/assets/img/bg/small-paw-2.png" alt="paw-image" >
        <img src="@/themes/doccure/assets/img/bg/small-paw-3.png" alt="paw-image" >
        <img src="@/themes/doccure/assets/img/bg/footer-round-bg.png" alt="paw-image">
      </div>
      <div class="container">
        <div class="row">
