                ...
                <div class="accordion" id="faq-details-info">
                  ...
                  <div class="accordion-item">
                    <h2 class="accordion-header" id="headingTen">
                      ...
                      >
                        What happens if my chosen doctor is unavailable for the selected
                        time?
                      </a>
                    </h2>
                    <div
...
<script>
import FaqOne from "@/themes/doccure/assets/json/faqone.json";
import FaqTwo from "@/themes/doccure/assets/json/faqtwo.json";
export default {
  data() {
    return {
      title: "FAQ",
