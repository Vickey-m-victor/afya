                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="about-inner-img">
                      <div class="about-img">
                        <img
                          src="@/themes/doccure/assets/img/about-img1.jpg"
                          class="img-fluid"
                          alt="Image"
                        />
                      </div>
                      <div class="about-img">
                        <img
                          src="@/themes/doccure/assets/img/about-img2.jpg"
                          class="img-fluid"
                          alt="Image"
                        />
                      </div>
                  ...
                  <div class="col-md-6">
                    <div class="about-inner-img">
                      ...
                      <div class="about-img">
                        <img
                          src="@/themes/doccure/assets/img/about-img3.jpg"
                          class="img-fluid"
                          alt="Image"
                        />
                      </div>
              ...
              <div class="about-content">
                <div class="about-content-details">
                  ...
                  <p>
                    ...
                    doloremque eaque ipsa quae architecto beatae vitae dicta sunt
                    explicabo.
                  </p>
                </div>
              ...
              <div class="card why-choose-card w-100">
                <div class="card-body">
                  <div class="why-choose-icon">
                    <span
                      ><img
                        :src="require(`@/themes/doccure/assets/img/icons/${item.Image}`)"
                        alt="Image"
                    /></span>
                  </div>
                  <div class="why-choose-content">
                    ...
                    <p>
                      ...
                      exercitation ullamco laboris nisi dolore magna enim veniam aliqua.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div class="way-bg">
            <div class="way-shapes-img">
              <div class="way-shapes-left">
                <img src="@/themes/doccure/assets/img/shape-06.png" alt="Image" />
              </div>
              <div class="way-shapes-right">
                <img src="@/themes/doccure/assets/img/shape-07.png" alt="Image" />
              </div>
            </div>
            <div class="row align-items-end">
              ...
              <div class="col-lg-5 col-md-12">
                <div class="way-img">
                  <img src="@/themes/doccure/assets/img/way-img.png" class="img-fluid" alt="Image" />
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="doc-pro-img">
                  <router-link to="/doctor-profile">
                    <div class="doctor-profile-img">
                      <img
                        :src="require(`@/themes/doccure/assets/img/doctors/${item.Image}`)"
                        class="img-fluid"
                        alt="Ruby Perrin"
                      />
                    </div>
                ...
                <div class="doc-content">
                  <div class="doc-pro-info">
                    ...
                    <div class="reviews-ratings">
                      <p>
                        <span><i class="fas fa-star"></i> {{ item.Rateing }}</span>
                        {{ item.Views }}
                      </p>
                    </div>
                  </div>
                  <div class="doc-pro-location">
                    <p><i class="isax isax-location"></i>{{ item.Location }}</p>
                    <span :class="item.Class"
                      ><i class="fa-solid fa-circle"></i>{{ item.Avaliable }}</span
                    >
                  </div>
                </div>
              </div>
      ...
      <section class="testimonial-section">
        <div class="testimonial-shape-img">
          <div class="testimonial-shape-left">
            <img src="@/themes/doccure/assets/img/shape-04.png" alt="Image" />
          </div>
          <div class="testimonial-shape-right">
            <img src="@/themes/doccure/assets/img/shape-05.png" alt="Image" />
          </div>
        </div>
        <div class="container">
          <div class="row">
                    ...
                    <div class="testimonial-grid">
                      <div class="testimonial-info">
                        <div class="testimonial-img">
                          <img
                            :src="require(`@/themes/doccure/assets/img/clients/${item.Image}`)"
                            class="img-fluid"
                            alt="client-image"
                          />
                        </div>
      ...
      <section class="faq-section faq-section-inner">
        <div class="container">
          ...
          <div class="row align-items-center">
            <div class="col-lg-6 col-md-12">
              <div class="faq-img">
                <img src="@/themes/doccure/assets/img/faq-img.png" class="img-fluid" alt="img" />
                <div class="faq-patients-count">
                  <div class="faq-smile-img">
                    <img src="@/themes/doccure/assets/img/icons/smiling-icon.svg" alt="icon" />
                  </div>
...
<script>
import AboutusChoose from "@/themes/doccure/assets/json/aboutuschoose.json";
import AboutusDoctors from "@/themes/doccure/assets/json/aboutusdoctors";
import { Carousel, Pagination, Navigation, Slide } from "vue3-carousel";
import IndexTestimonial from "@/themes/doccure/assets/json/indextestimonial.json";
