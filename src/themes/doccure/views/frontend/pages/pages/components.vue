<template>
  <div class="main-wrapper">
    ...
    <breadcrumb :title="title" :text="text" />
    <!-- Page Content -->
    <div class="content">
      <div class="container">
                  ...
                  <div class="card-body">
                    <div class="avatar avatar-xxl">
                      <img
                        ...
                        alt="User Image"
                        src="@/themes/doccure/assets/img/patients/patient8.jpg"
                      />
                    </div>
                    ...
                    <div class="avatar-group">
                      ...
                      <div class="avatar">
                        <img
                          class="avatar-img rounded-circle border border-white"
                          alt="User Image"
                          src="@/themes/doccure/assets/img/patients/patient2.jpg"
                        />
                      </div>
                      <div class="avatar">
                        <img
                          class="avatar-img rounded-circle border border-white"
                          alt="User Image"
                          src="@/themes/doccure/assets/img/patients/patient3.jpg"
                        />
                      </div>
                      <div class="avatar">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="alert alert-warning alert-dismissible fade show" role="alert">
                  ...
                  <a href="#" class="alert-link">network connection</a>.
                  <button
                    type="button"
                    class="btn-close"
                    data-bs-dismiss="alert"
                ...
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                  ...
                  <a href="#" class="alert-link">message</a> has been sent successfully.
                  <button
                    type="button"
                    class="btn-close"
                    data-bs-dismiss="alert"
                ...
                <div class="alert alert-info alert-dismissible fade show" role="alert">
                  ...
                  <a href="#" class="alert-link">comments</a> carefully.
                  <button
                    type="button"
                    class="btn-close"
                    data-bs-dismiss="alert"
          ...
          <section class="comp-section comp-buttons">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <hr />
                <p>
                  use <code>.btn-rounded</code> in class <code>.btn-outline-*</code> class
                  to get Rounded Outline button
                </p>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="row row-sm align-items-center">
                  ...
                  <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                    <button type="button" class="btn w-100 btn-outline-success">
                      Success
                    </button>
                  </div>
                  <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                    <button type="button" class="btn w-100 btn-outline-warning">
                      Warning
                    </button>
                  </div>
                  <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                ...
                <div class="row row-sm align-items-center mt-3">
                  ...
                  <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                    <button type="button" class="btn w-100 btn-outline-primary active">
                      Primary
                    </button>
                  </div>
                  <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                    <button type="button" class="btn w-100 btn-outline-secondary active">
                      Secondary
                    </button>
                  </div>
                  <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                    <button type="button" class="btn w-100 btn-outline-success active">
                      Success
                    </button>
                  </div>
                  <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                    <button type="button" class="btn w-100 btn-outline-warning active">
                      Warning
                    </button>
                  </div>
                  <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                    <button type="button" class="btn w-100 btn-outline-danger active">
                      Danger
                    </button>
                  </div>
                  <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                    <button type="button" class="btn w-100 btn-outline-info active">
                      Info
                    </button>
                  </div>
                  <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                    <button type="button" class="btn w-100 btn-outline-light active">
                      Light
                    </button>
                  </div>
                  <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                    <button type="button" class="btn w-100 btn-outline-dark active">
                      Dark
                    </button>
                  </div>
                </div>
                <div class="row row-sm align-items-center mt-3">
                  ...
                  <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                    <button disabled="" type="button" class="btn w-100 btn-outline-info">
                      Info
                    </button>
                  </div>
                  <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                    <button disabled="" type="button" class="btn w-100 btn-outline-light">
                      Light
                    </button>
                  </div>
                  <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                    <button disabled="" type="button" class="btn w-100 btn-outline-dark">
                      Dark
                    </button>
                  </div>
                </div>
            ...
            <div class="row">
              <div class="col-12 col-md-6 col-lg-4 d-flex">
                <div class="card flex-fill">
                  <img
                    alt="Card Image"
                    src="@/themes/doccure/assets/img/img-01.jpg"
                    class="card-img-top"
                  />
                  <div class="card-header">
                ...
                <div class="card flex-fill">
                  <div class="card-header">
                    <ul role="tablist" class="nav nav-tabs card-header-tabs float-end">
                      ...
                      <li class="nav-item">
                        <a href="#tab-3" data-bs-toggle="tab" class="nav-link disabled"
                          >Disabled</a
                        >
                      </li>
                    </ul>
                ...
                <div class="card flex-fill">
                  <div class="card-header">
                    <ul role="tablist" class="nav nav-pills card-header-pills float-end">
                      ...
                      <li class="nav-item">
                        <a href="#tab-6" data-bs-toggle="tab" class="nav-link disabled"
                          >Disabled</a
                        >
                      </li>
                    </ul>
          ...
          <section class="comp-section">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <p>
                  ...
                  for padding), and modal footer (optional). We ask that you include modal
            ...
            <div class="card">
              ...
              <div class="card-body">
                <!-- Simple demo-->
                <button
                  class="btn btn-primary custom-components"
                  type="button"
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <ul class="nav nav-tabs">
                      <li class="nav-item">
                        <a class="nav-link active" href="#basictab1" data-bs-toggle="tab"
                          >Home</a
                        >
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="#basictab2" data-bs-toggle="tab"
                          >Profile</a
                        >
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="#basictab3" data-bs-toggle="tab"
                          >Messages</a
                        >
                      </li>
                    </ul>
                    <div class="tab-content">
                      <div class="tab-pane show active" id="basictab1">Tab content 1</div>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="tab-content">
                      ...
                      <div class="tab-pane" id="basic-justified-tab2">Tab content 2</div>
                      <div class="tab-pane" id="basic-justified-tab3">Tab content 3</div>
                      <div class="tab-pane" id="basic-justified-tab4">Tab content 4</div>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <ul class="nav nav-tabs nav-tabs-top">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="#top-tab3" data-bs-toggle="tab"
                          >Messages</a
                        >
                      </li>
                    </ul>
                    <div class="tab-content">
                      <div class="tab-pane show active" id="top-tab1">Tab content 1</div>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="tab-content">
                      ...
                      <div class="tab-pane" id="top-justified-tab2">Tab content 2</div>

                      <div class="tab-pane" id="top-justified-tab3">Tab content 3</div>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <ul class="nav nav-tabs nav-tabs-solid">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="#solid-tab3" data-bs-toggle="tab"
                          >Messages</a
                        >
                      </li>
                    </ul>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="tab-content">
                      ...
                      <div class="tab-pane" id="solid-justified-tab2">Tab content 2</div>
                      <div class="tab-pane" id="solid-justified-tab3">Tab content 3</div>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="tab-content">
                      ...
                      <div class="tab-pane" id="solid-rounded-tab2">Tab content 2</div>
                      <div class="tab-pane" id="solid-rounded-tab3">Tab content 3</div>
                    </div>
                  </div>
                </div>
              </div>
