                  ...
                  <div class="booking-doctor-left">
                    <div class="booking-doctor-img">
                      <router-link to="/doctor-profile">
                        <img src="@/themes/doccure/assets/img/doctors/doctor-02.jpg" alt="John Doe" />
                      </router-link>
                    </div>
            ...
            <div class="card booking-card">
              <div class="card-body booking-card-body booking-list-body">
                <div class="booking-list">
                  ...
                  <div class="booking-doctor-right">
                    <p>
                      <router-link to="/booking">Edit</router-link>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="card-body booking-card-body">
                <div class="booking-doctor-details">
                  <div class="booking-doctor-left">
                    <div class="booking-doctor-img">
                      <a href="javascript:void(0);">
                        <img src="@/themes/doccure/assets/img/patients/patient3.jpg" alt="John Smith" />
                      </a>
                    </div>
                    <div class="booking-doctor-info">
                      <h4><router-link to="/profile-settings">John Smith</router-link></h4>
                      <p>P123456</p>
                    </div>
                  </div>
                  <div class="booking-doctor-right">
                    <p>
                      <router-link to="/profile-settings">Edit</router-link>
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div class="booking-doctor-details">
                  <div class="booking-device">
                    <div class="booking-device-img">
                      <img
                        src="@/themes/doccure/assets/img/icons/device-message.svg"
            ...
            <div class="card booking-card mb-0">
              <div class="card-body booking-card-body">
                <div class="booking-doctor-details">
                  <div class="booking-device">
                    <div class="booking-device-img">
                      <img src="@/themes/doccure/assets/img/icons/smart-phone.svg" alt="smart-phone" />
                    </div>
                    <div class="booking-doctor-info">
                      <h3>Get the App</h3>
                      <p class="device-text">
                      ...
                      <div class="app-images">
                        <a href="javascript:void(0);">
                          <img src="@/themes/doccure/assets/img/google-img.svg" alt="google-image" />
                        </a>
                        <a href="javascript:void(0);">
                          <img src="@/themes/doccure/assets/img/app-img.svg" alt="app-image" />
                        </a>
                      </div>
                    </div>
                  </div>
