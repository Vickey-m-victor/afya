        ...
        <div class="row">
          <div class="col-md-12">
            <div class="terms-text">
              <h6>Introduction</h6>
              <p>
                Welcome to Doccure, a platform that allows you to book appointments with
                healthcare professionals. By using our services, you agree to these Terms
            ...
            <div class="terms-text terms-list">
              ...
              <ul>
                ...
                <li>
                  ...
                  practitioners, and [Website Name] does not guarantee the quality or
                  accuracy of medical advice provided.
                </li>
              </ul>
            </div>
            <div class="terms-text terms-list">
              ...
              <ul>
                <li>
                  Payment for appointments may be made through [Payment Method] and is
                  subject to [Insert Payment Terms].
                </li>
                <li>
            ...
            <div class="terms-text terms-list">
              ...
              <p>
                Doccure may update these Privacy Policy periodically. Any changes will be
                communicated through the website or via email.
              </p>
            </div>
          </div>
        </div>
