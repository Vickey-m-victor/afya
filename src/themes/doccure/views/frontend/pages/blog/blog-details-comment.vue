          ...
          <div class="comment">
            <div class="comment-author">
              <img
                ...
                src="@/themes/doccure/assets/img/patients/patient4.jpg"
              />
            </div>
              ...
              <div class="comment">
                <div class="comment-author">
                  <img
                    class="avatar"
                    alt="Gina Moore"
                    src="@/themes/doccure/assets/img/patients/patient5.jpg"
                  />
                </div>
                <div class="comment-block">
                  <span class="comment-by">
          ...
          <div class="comment">
            <div class="comment-author">
              <img
                class="avatar"
                alt="Elsie Gilley"
                src="@/themes/doccure/assets/img/patients/patient6.jpg"
              />
            </div>
            <div class="comment-block">
              <span class="comment-by">
          ...
          <div class="comment">
            <div class="comment-author">
              <img
                class="avatar"
                alt="Joan Gardner"
                src="@/themes/doccure/assets/img/patients/patient7.jpg"
              />
            </div>
            <div class="comment-block">
              <span class="comment-by">
