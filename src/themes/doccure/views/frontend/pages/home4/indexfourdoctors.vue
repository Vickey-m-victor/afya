          ...
          <div class="book-best-doctors">
            <div class="book-header">
              <router-link to="/doctor-profile"
                ><img
                  :src="require(`@/themes/doccure/assets/img/doctors/${doctor.imageSrc}`)"
                  :alt="doctor.name"
                  class="img-fluid"
              /></router-link>
            ...
            <div class="doctors-body">
              ...
              <div class="row row-sm loc-details">
                <div class="col-6">
                  <div class="d-flex align-items-center">
                    <a href="javascript:void(0);">
                      <img src="@/themes/doccure/assets/img/shapes/map-plus.png" alt="Image" />
                    </a>
                    <a href="javascript:void(0);">
                ...
                <div class="col-6">
                  <div class="d-flex align-items-center">
                    <a href="javascript:void(0);">
                      <img src="@/themes/doccure/assets/img/shapes/alarm.png" alt="Image" />
                    </a>
                    <a href="javascript:void(0);">
                ...
                <div class="col-6">
                  <div class="d-flex align-items-center">
                    <a href="javascript:void(0);">
                      <img src="@/themes/doccure/assets/img/shapes/consult.png" alt="Image" />
                    </a>
                    <a href="javascript:void(0);">
                ...
                <div class="col-6">
                  <div class="d-flex align-items-center">
                    <a href="javascript:void(0);">
                      <img src="@/themes/doccure/assets/img/shapes/exper.png" alt="Image" />
                    </a>
                    <a href="javascript:void(0);">
...
import indexfourdoctors from "@/themes/doccure/assets/json/indexfourdoctors.json";
export default {
  data() {
    return {
