      ...
      <div class="row">
        <div class="col-md-9 m-auto">
          ...
          <div class="row">
            ...
            <div class="col-lg-4 mb-3 aos" data-aos="fade-up">
              <div class="card text-center doctor-book-card">
                <img src="@/themes/doccure/assets/img/img-pharmacy1.jpg" alt="Image" class="img-fluid" />
                <div class="doctor-book-card-content tile-card-content-1">
                  <div>
            ...
            <div class="col-lg-4 mb-3 aos" data-aos="fade-up">
              <div class="card text-center doctor-book-card">
                <img src="@/themes/doccure/assets/img/lab-image.jpg" alt="Image" class="img-fluid" />
                <div class="doctor-book-card-content tile-card-content-1">
                  <div>
