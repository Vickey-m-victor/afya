                ...
                <div class="table-responsive">
                  ...
                  <a-table :columns="columns" :data-source="data">
                    <template #bodyCell="{ column, record }">
                        ...
                        <h2 class="table-avatar">
                          ...
                          >
                            <img
                              ...
                              :src="
                                require(`@/themes/doccure/assets/admin/img/doctors/${record.Image}`)
                              "
                              alt="User Image"
                            />
                          </router-link>
                      ...
                      <template v-else-if="column.key === 'MemberSince'">
                        <div>
                          {{ record.MemberSince }} <br /><small>{{
                            record.Time
                          }}</small>
                        </div>
                      </template>
                      <template v-else-if="column.key === 'AccountStatus'">
                        <div class="status-toggle">
                          <input
                            ...
                            checked
                          />
                          <label :for="record.IdName" class="checktoggle"
                            >checkbox</label
                          >
                        </div>
                      </template>
...
const columns = [
  ...
  },
  {
    ...
    sorter: {
      compare: (a, b) => {
        a = a.MemberSince.toLowerCase();
        b = b.MemberSince.toLowerCase();
        return a > b ? -1 : b > a ? 1 : 0;
      },
    },
  },
  {
    ...
    sorter: {
      compare: (a, b) => {
        a = a.Earned.toLowerCase();
        b = b.Earned.toLowerCase();
        return a > b ? -1 : b > a ? 1 : 0;
      },
    },
  },
  {
    ...
    sorter: {
      compare: (a, b) => {
        a = a.AccountStatus.toLowerCase();
        b = b.AccountStatus.toLowerCase();
        return a > b ? -1 : b > a ? 1 : 0;
      },
    },
  },
