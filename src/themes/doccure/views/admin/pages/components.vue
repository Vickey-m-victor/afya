        ...
        <div class="comp-sec-wrapper">
                  ...
                  <div class="card-body">
                    <div class="avatar avatar-xxl me-1">
                      <img
                        ...
                        alt="User Image"
                        src="@/themes/doccure/assets/admin/img/profiles/avatar-02.jpg"
                      />
                    </div>
              ...
              <div class="col-md-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="avatar avatar-away me-1">
                      <img
                        class="avatar-img rounded-circle"
                        alt="User Image"
                        src="@/themes/doccure/assets/admin/img/profiles/avatar-02.jpg"
                    ...
                    <div class="avatar-group">
                      ...
                      <div class="avatar">
                        <img
                          class="avatar-img rounded-circle border border-white"
                          alt="User Image"
                          src="@/themes/doccure/assets/admin/img/profiles/avatar-03.jpg"
                        />
                      </div>
                      <div class="avatar">
                        <img
                          class="avatar-img rounded-circle border border-white"
                          alt="User Image"
                          src="@/themes/doccure/assets/admin/img/profiles/avatar-04.jpg"
                        />
                      </div>
                      <div class="avatar">
                        <span
          ...
          <section class="comp-section comp-buttons">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <p>
                  ...
                  <b-button size="sm" variant="secondary me-1"
                    >Secondary</b-button
                  >
            ...
            <div class="card">
              ...
              <div class="card-body">
                <b-button class="btn me-1 btn-rounded btn-primary">
                  Primary
                </b-button>
                <b-button class="btn me-1 btn-rounded btn-secondary">
                  Secondary
                </b-button>
                <b-button class="btn me-1 btn-rounded btn-success">
                  Success
                </b-button>
                <b-button class="btn me-1 btn-rounded btn-danger">
                  Danger
                </b-button>
                <b-button class="btn me-1 btn-rounded btn-warning">
                  Warning
                </b-button>
                <b-button class="btn me-1 btn-rounded btn-info">Info</b-button>
                <b-button class="btn me-1 btn-rounded btn-light">
                  Light
                </b-button>
                <b-button class="btn btn-rounded btn-dark">Dark</b-button>
                <hr />
                <p>
                ...
                <b-button variant="btn me-1 btn-rounded btn-outline-primary">
                  Primary
                </b-button>
                <b-button variant="btn me-1 btn-rounded btn-outline-secondary">
                  Secondary
                </b-button>
                <b-button variant="btn me-1 btn-rounded btn-outline-success">
                  Sucucess
                </b-button>
                <b-button variant="btn me-1 btn-rounded btn-outline-danger">
                  Danger
                </b-button>
                <b-button variant="btn me-1 btn-rounded btn-outline-warning">
                  Warning
                </b-button>
                <b-button variant="btn me-1 btn-rounded btn-outline-info">
                  Info
                </b-button>
                <b-button variant="btn me-1 btn-rounded btn-outline-light">
                  Light
                </b-button>
                <b-button variant="btn btn-rounded btn-outline-dark">
                  Dark
                </b-button>
              </div>
            </div>
              ...
              <div class="card-body">
                <div class="row row-sm align-items-center">
                  ...
                  <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                    <b-button variant="outline-primary btn-block w-100"
                      >Primary</b-button
                    >
                  </div>
                  <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                    <b-button variant="outline-secondary btn-block w-100"
                      >Secondary</b-button
                    >
                  </div>
                  <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                    <b-button variant="outline-success btn-block w-100"
                      >Success</b-button
                    >
                  </div>
                  <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                    <b-button variant="outline-warning btn-block w-100"
                      >Warning</b-button
                    >
                  </div>
                  <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                    <b-button variant="outline-danger btn-block w-100"
                      >Danger</b-button
                    >
                  </div>
                  <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                    <b-button variant="outline-info btn-block w-100"
                      >Info</b-button
                    >
                  </div>
                  <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                    <b-button variant="outline-light btn-block w-100"
                      >Light</b-button
                    >
                  </div>
                  <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                    <b-button variant="outline-dark btn-block w-100"
                      >Dark</b-button
                    >
                  </div>
                </div>
                <div class="row row-sm align-items-center mt-3">
                  ...
                  <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                    <b-button variant="outline-primary btn-block active w-100"
                      >Primary</b-button
                    >
                  </div>
                  <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                    <b-button variant="outline-secondary btn-block active w-100"
                      >Secondary</b-button
                    >
                  </div>
                  <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                    <b-button variant="outline-success btn-block active w-100"
                      >Success</b-button
                    >
                  </div>
                  <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                    <b-button variant="outline-warning btn-block active w-100"
                      >Warning</b-button
                    >
                  </div>
                  <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                    <b-button variant="outline-danger btn-block active w-100"
                      >Danger</b-button
                    >
                  </div>
                  <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                    <b-button variant="outline-info btn-block active w-100"
                      >Info</b-button
                    >
                  </div>
                  <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                    <b-button variant="outline-light btn-block active w-100"
                      >Light</b-button
                    >
                  </div>
                  <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                    <b-button variant="outline-dark btn-block active w-100"
                      >Dark</b-button
                    >
                  </div>
                </div>
                <div class="row row-sm align-items-center mt-3">
                  ...
                  <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                    <b-button disabled variant="outline-primary btn-block w-100"
                      >Primary</b-button
                    >
                  </div>
                  <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                    <b-button
                      disabled
                      variant="outline-secondary btn-block w-100"
                      >Secondary</b-button
                    >
                  </div>
                  <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                    <b-button disabled variant="outline-success btn-block w-100"
                      >Success</b-button
                    >
                  </div>
                  <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                    <b-button disabled variant="outline-warning btn-block w-100"
                      >Warning</b-button
                    >
                  </div>
                  <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                    <b-button disabled variant="outline-danger btn-block w-100"
                      >Danger</b-button
                    >
                  </div>
                  <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                    <b-button disabled variant="outline-info btn-block w-100"
                      >Info</b-button
                    >
                  </div>
                  <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                    <b-button disabled variant="outline-light btn-block w-100"
                      >Light</b-button
                    >
                  </div>
                  <div class="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0">
                    <b-button disabled variant="outline-dark btn-block w-100"
                      >Dark</b-button
                    >
                  </div>
                </div>
            ...
            <div class="row">
              <div class="col-12 col-md-6 col-lg-4 d-flex">
                <div class="card flex-fill">
                  <img
                    alt="Card Image"
                    src="@/themes/doccure/assets/admin/img/img-01.jpg"
                    class="card-img-top"
                  />
                  <div class="card-header">
              ...
              <div class="col-12 col-md-6 col-lg-4 d-flex">
                <div class="card flex-fill">
                  ...
                  <div class="card-body">
                    ...
                    <a variant="primary" href="javascript:void(0);"
                      >Go somewhere</a
                    >
                  </div>
                </div>
            ...
            <div class="row">
              <div class="col-12 col-md-6 col-lg-4 d-flex">
                <div class="card flex-fill">
                  ...
                  <div class="card-footer text-muted">This is my footer</div>
                </div>
              </div>
              ...
              <div class="col-12 col-md-6 col-lg-4 d-flex">
                <div class="card flex-fill">
                  <div class="card-header">
                    <ul
                      role="tablist"
                      class="nav nav-pills card-header-pills float-end"
                    >
                      <li class="nav-item">
                        <a
                          href="#tab-4"
            ...
            <div class="card bg-white">
              <div class="card-body">
                ...
                <div class="btn-group">
                  <b-button
                    type="button"
                    class="btn me-1 btn-primary dropdown-toggle"
                    data-bs-toggle="dropdown"
                    aria-haspopup="true"
                    aria-expanded="false"
                  >
                ...
                <div class="btn-group">
                  <b-button
                    type="button"
                    class="btn me-1 btn-secondary dropdown-toggle"
                    data-bs-toggle="dropdown"
                    aria-haspopup="true"
                    aria-expanded="false"
                  >
                ...
                <div class="btn-group">
                  <b-button
                    type="button"
                    class="btn me-1 btn-info dropdown-toggle"
                    data-bs-toggle="dropdown"
                    aria-haspopup="true"
                    aria-expanded="false"
                  >
                ...
                <div class="btn-group">
                  <b-button
                    type="button"
                    class="btn me-1 btn-success dropdown-toggle"
                    data-bs-toggle="dropdown"
                    aria-haspopup="true"
                    aria-expanded="false"
                  >
                ...
                <div class="btn-group">
                  <b-button
                    type="button"
                    class="btn me-1 btn-warning dropdown-toggle"
                    data-bs-toggle="dropdown"
                    aria-haspopup="true"
                    aria-expanded="false"
                  >
                ...
                <div class="btn-group">
                  <b-button
                    type="button"
                    class="btn me-1 btn-danger dropdown-toggle"
                    data-bs-toggle="dropdown"
                    aria-haspopup="true"
                    aria-expanded="false"
                  >
                ...
                <div class="btn-group">
                  ...
                  <b-button
                    type="button"
                    class="btn me-1 btn-primary dropdown-toggle dropdown-toggle-split"
                    data-bs-toggle="dropdown"
                    aria-haspopup="true"
                    aria-expanded="false"
                  >
                ...
                <div class="btn-group">
                  ...
                  <b-button
                    type="button"
                    class="btn me-1 btn-secondary dropdown-toggle dropdown-toggle-split"
                    data-bs-toggle="dropdown"
                    aria-haspopup="true"
                    aria-expanded="false"
                  >
                ...
                <div class="btn-group">
                  <b-button type="button" class="btn btn-info">Action</b-button>
                  <b-button
                    type="button"
                    class="btn me-1 btn-info dropdown-toggle dropdown-toggle-split"
                    data-bs-toggle="dropdown"
                    aria-haspopup="true"
                    aria-expanded="false"
                  >
                ...
                <div class="btn-group">
                  ...
                  <b-button
                    type="button"
                    class="btn me-1 btn-success dropdown-toggle dropdown-toggle-split"
                    data-bs-toggle="dropdown"
                    aria-haspopup="true"
                    aria-expanded="false"
                  >
                ...
                <div class="btn-group">
                  <b-button type="button" class="btn btn-warning"
                    >Action</b-button
                  >
                  <b-button
                    type="button"
                    class="btn me-1 btn-warning dropdown-toggle dropdown-toggle-split"
                    data-bs-toggle="dropdown"
                    aria-haspopup="true"
                    aria-expanded="false"
                  >
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="tab-content">
                      ...
                      <div class="tab-pane" id="basictab2">Tab content 2</div>
                      <div class="tab-pane" id="basictab3">Tab content 3</div>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="tab-content">
                      ...
                      <div class="tab-pane" id="top-tab2">Tab content 2</div>
                      <div class="tab-pane" id="top-tab3">Tab content 3</div>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="tab-content">
                      ...
                      <div class="tab-pane" id="solid-tab2">Tab content 2</div>
                      <div class="tab-pane" id="solid-tab3">Tab content 3</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4 d-flex">
                <div class="card flex-fill">
                  ...
                  <div class="card-body">
                    ...
                    <p>
                      <a href="javascript:void(0);" class="text-light bg-dark"
                        >Light link</a
                      >
                    </p>
                    <p>
