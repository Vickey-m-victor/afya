                        ...
                        <h2 class="table-avatar">
                          <router-link
                            ...
                            ><img
                              ...
                              :src="
                                require(`@/themes/doccure/assets/admin/img/patients/${record.PatientImage}`)
                              "
                              alt="User Image"
                          /></router-link>
                        ...
                        <h2 class="table-avatar">
                          <router-link
                            ...
                            ><img
                              class="avatar-img rounded-circle"
                              :src="
                                require(`@/themes/doccure/assets/admin/img/doctors/${record.DoctorImage}`)
                              "
                              alt="User Image"
                          /></router-link>
                          <router-link to="/admin/profile">{{
