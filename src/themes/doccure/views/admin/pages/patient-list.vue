                        ...
                        <h2 class="table-avatar">
                          <router-link
                            ...
                            ><img
                              ...
                              :src="
                                require(`@/themes/doccure/assets/admin/img/patients/${record.PatientImg}`)
                              "
                              alt="User Image"
                          /></router-link>
...
const columns = [
...

  {
    ...
    sorter: {
      compare: (a, b) => {
        a = a.LastVisit.toLowerCase();
        b = b.LastVisit.toLowerCase();
        return a > b ? -1 : b > a ? 1 : 0;
      },
    },
  },
