  ...
  <div class="header">
    ...
    <div class="header-left">
      <router-link to="/admin/index" class="logo">
        <img src="@/themes/doccure/assets/admin/img/logo.png" alt="Logo" />
      </router-link>
      <router-link to="/admin/index" class="logo logo-small">
        <img src="@/themes/doccure/assets/admin/img/logo-small.png" alt="Logo" width="30" height="30" />
      </router-link>
    </div>
    <!-- /Logo -->
                  ...
                  <div class="media d-flex">
                    <span class="avatar avatar-sm flex-shrink-0">
                      <img
                        ...
                        alt="User Image"
                        src="@/themes/doccure/assets/admin/img/doctors/doctor-thumb-01.jpg"
                      />
                    </span>
                  ...
                  <div class="media d-flex">
                    <span class="avatar avatar-sm flex-shrink-0">
                      <img
                        class="avatar-img rounded-circle"
                        alt="User Image"
                        src="@/themes/doccure/assets/img/patients/patient1.jpg"
                      />
                    </span>
                    <div class="media-body flex-grow-1">
                      <p class="noti-details">
        ...
        >
          <span class="user-img"
            ><img
              ...
              src="@/themes/doccure/assets/admin/img/profiles/avatar-01.jpg"
              width="31"
              alt="Ryan Taylor"
          /></span>
        </a>
