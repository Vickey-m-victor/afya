        ...
        <div class="invoice-container">
          <div class="row">
            <div class="col-sm-6 m-b-20">
              <img
                alt="Logo"
                class="inv-logo img-fluid"
                src="@/themes/doccure/assets/pharmacy/img/logo.png"
              />
            </div>
            <div class="col-sm-6 m-b-20">
              <div class="invoice-details">
                ...
                <ul class="list-unstyled mb-0">
                  <li>
                    Date: <span>14-5-{{ new Date().getFullYear() }}</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-sm-6 col-lg-7 col-xl-8 m-b-20">
              ...
              <ul class="list-unstyled">
                ...
                <li>United States</li>
                <li>8286329170</li>
                <li><a href="javascript:;">charlenereed@example.com</a></li>
              </ul>
            </div>
