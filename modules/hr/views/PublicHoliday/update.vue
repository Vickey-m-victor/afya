...
async function handleSubmit(payload) {
  ...
  handleResponseAlert(alertStore, responseData.value, 'PublicHoliday updated successfully.');
  router.push({ name: 'hr/public-holiday' });
}
</script>
  ...
  <div class="content">
    <div class="block block-rounded">
      <div class="block-header block-header-default">
        <h3 class="block-title">Update PublicHoliday</h3>
      </div>
