...
<template>
    <form @submit.prevent="handleSubmit">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <label class="form-label" for="field-employer_type_id">Employer type id</label>
                
                <input
                    id="field-employer_type_id"
                    v-model.number="formData.employer_type_id"
                    type="number"
                    
                    class="form-control"
                    :class="{ 'is-invalid': fieldError('employer_type_id') }"
                    :disabled="readonly || busy"
                />
                
                <div v-if="fieldError('employer_type_id')" class="invalid-feedback">{{ fieldError('employer_type_id') }}</div>
            </div>
