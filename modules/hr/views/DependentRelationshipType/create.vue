...
async function handleSubmit(payload) {
  ...
  handleResponseAlert(alertStore, responseData.value, 'DependentRelationshipType created successfully.');
  router.push({ name: 'hr/dependent-relationship-type' });
}
</script>
  ...
  <div class="content">
    <div class="block block-rounded">
      <div class="block-header block-header-default">
        <h3 class="block-title">Create DependentRelationshipType</h3>
      </div>
