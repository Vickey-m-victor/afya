...
async function handleSubmit(payload) {
  ...
  handleResponseAlert(alertStore, responseData.value, 'EmploymentType created successfully.');
  router.push({ name: 'hr/employment-type' });
}
</script>
  ...
  <div class="content">
    <div class="block block-rounded">
      <div class="block-header block-header-default">
        <h3 class="block-title">Create EmploymentType</h3>
      </div>
