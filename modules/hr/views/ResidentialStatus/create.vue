...
async function handleSubmit(payload) {
  ...
  handleResponseAlert(alertStore, responseData.value, 'ResidentialStatus created successfully.');
  router.push({ name: 'hr/residential-status' });
}
</script>
  ...
  <div class="content">
    <div class="block block-rounded">
      <div class="block-header block-header-default">
        <h3 class="block-title">Create ResidentialStatus</h3>
      </div>
