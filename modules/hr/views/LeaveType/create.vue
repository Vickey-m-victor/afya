...
async function handleSubmit(payload) {
  ...
  handleResponseAlert(alertStore, responseData.value, 'LeaveType created successfully.');
  router.push({ name: 'hr/leave-type' });
}
</script>
  ...
  <div class="content">
    <div class="block block-rounded">
      <div class="block-header block-header-default">
        <h3 class="block-title">Create LeaveType</h3>
      </div>
