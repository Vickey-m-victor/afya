...
async function handleSubmit(payload) {
  ...
  handleResponseAlert(alertStore, responseData.value, 'PayrollSetting updated successfully.');
  router.push({ name: 'hr/payroll-setting' });
}
</script>
  ...
  <div class="content">
    <div class="block block-rounded">
      <div class="block-header block-header-default">
        <h3 class="block-title">Update PayrollSetting</h3>
      </div>
