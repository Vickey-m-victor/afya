...
const tableColumns = [
  ...
  {
    "field": "tax_calculation_method",
    "header": "Tax Calculation Method"
  },
  {
    "field": "status",
    "header": "Status"
...
function handleCreate() {
  ...
  if (!modalStore.useModal) {
    router.push({ name: 'hr/payroll-setting/create' });
    return;
  }
...
function handleView(row) {
  ...
  if (!modalStore.useModal) {
    const id = rowId(row);
    router.push({ name: 'hr/payroll-setting/view', params: { id } });
    return;
  }
...
function handleEdit(row) {
  ...
  if (!modalStore.useModal) {
    const id = rowId(row);
    router.push({ name: 'hr/payroll-setting/update', params: { id } });
    return;
  }
...
async function handleSubmit(payload) {
  ...
  handleResponseAlert(
    ...
    responseData.value,
    isEdit
      ? 'PayrollSetting updated successfully.'
      : 'PayrollSetting created successfully.'
  );
...
<template>
  <div class="content">
    <DataTable
      ...
      search-placeholder="Search payroll-setting..."
      create-label="New PayrollSetting"
      :paginated="true"
