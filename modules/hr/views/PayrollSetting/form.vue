...
<template>
    <form @submit.prevent="handleSubmit">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <label class="form-label" for="field-payroll_setting_id">Payroll setting id</label>
                
                <input
                    id="field-payroll_setting_id"
                    v-model.number="formData.payroll_setting_id"
                    type="number"
                    
                    class="form-control"
                    :class="{ 'is-invalid': fieldError('payroll_setting_id') }"
                    :disabled="readonly || busy"
                />
                
                <div v-if="fieldError('payroll_setting_id')" class="invalid-feedback">{{ fieldError('payroll_setting_id') }}</div>
            </div>
