...
function handleView(row) {
  ...
  openFormModal('View StatutoryRate', { ...row }, true);
}
...
function handleEdit(row) {
  ...
  openFormModal('Edit StatutoryRate', { ...row }, false);
}
...
async function handleDelete(row) {
  ...
  handleResponseAlert(alertStore, responseData.value, 'StatutoryRate deleted successfully.');
  await fetchRows();
}
