...
async function handleSubmit(payload) {
  ...
  handleResponseAlert(alertStore, responseData.value, 'StatutoryRate updated successfully.');
  router.push({ name: 'hr/statutory-rate' });
}
</script>
  ...
  <div class="content">
    <div class="block block-rounded">
      <div class="block-header block-header-default">
        <h3 class="block-title">Update StatutoryRate</h3>
      </div>
