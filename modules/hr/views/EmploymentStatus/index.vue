...
function handleView(row) {
  ...
  openFormModal('View EmploymentStatus', { ...row }, true);
}
...
function handleEdit(row) {
  ...
  openFormModal('Edit EmploymentStatus', { ...row }, false);
}
...
async function handleDelete(row) {
  ...
  handleResponseAlert(alertStore, responseData.value, 'EmploymentStatus deleted successfully.');
  await fetchRows();
}
