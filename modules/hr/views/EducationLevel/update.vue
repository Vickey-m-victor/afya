...
async function handleSubmit(payload) {
  ...
  handleResponseAlert(alertStore, responseData.value, 'EducationLevel updated successfully.');
  router.push({ name: 'hr/education-level' });
}
</script>
  ...
  <div class="content">
    <div class="block block-rounded">
      <div class="block-header block-header-default">
        <h3 class="block-title">Update EducationLevel</h3>
      </div>
