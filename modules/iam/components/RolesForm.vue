...
<template>
  <form @submit.prevent="onSubmit">
    ...
    <div v-if="compact" class="compact-form">
      <div class="mb-3">
        <label class="form-label" for="role-id-input">
        ...
        />
        <div v-if="fieldErrors?.role_id" class="invalid-feedback">
          {{ fieldErrors.role_id }}
        </div>
      </div>

      <div class="mb-3">
        <label class="form-label" for="role-name-input">
    ...
    <div v-else class="row">
      <div class="col-lg-12 mb-4">
        <label class="form-label" for="role-id-input-full">
          Role ID <span class="text-danger">*</span>
        </label>
        <input
          type="text"
      ...
      <div class="col-lg-12 mb-4">
        <label class="form-label" for="role-name-input-full">
          Role Name <span class="text-danger">*</span>
        </label>
        <input
          type="text"
