...
<template>
  <form @submit.prevent="onSubmit">
    ...
    <div v-if="compact" class="compact-form">
      <div class="mb-3">
        <label class="form-label" for="permission-id-input">
          Permission ID <span class="text-danger">*</span>
        </label>
        <input
          type="text"
          class="form-control form-control-sm"
          :class="{ 'is-invalid': fieldErrors?.permission_id }"
          id="permission-id-input"
          v-model="formData.permission_id"
          placeholder="Enter permission ID"
          :disabled="readonly || isSubmitting"
        />
        <div v-if="fieldErrors?.permission_id" class="invalid-feedback">
          {{ fieldErrors.permission_id }}
        </div>
      </div>

      <div class="mb-3">
        <label class="form-label" for="permission-name-input">
          Permission Name <span class="text-danger">*</span>
        </label>
        <input
          type="text"
          class="form-control form-control-sm"
          :class="{ 'is-invalid': fieldErrors?.permission_name }"
          id="permission-name-input"
          v-model="formData.permission_name"
          placeholder="Enter permission name"
          :disabled="readonly || isSubmitting"
        />
        <div v-if="fieldErrors?.permission_name" class="invalid-feedback">
    ...
    <div v-else class="row">
      <div class="col-lg-12 mb-4">
        <label class="form-label" for="permission-id-input-full">
          Permission ID <span class="text-danger">*</span>
        </label>
        <input
          type="text"
      ...
      <div class="col-lg-12 mb-4">
        <label class="form-label" for="permission-name-input-full">
          Permission Name <span class="text-danger">*</span>
        </label>
        <input
          type="text"
